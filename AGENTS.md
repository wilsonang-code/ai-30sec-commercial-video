# ai-30sec-commercial-video

AI-powered 30-second commercial video generator that takes a client brief through story design, AI scene generation, and video rendering to a client-accepted final video — tracked on a shared team dashboard.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "238497814+wilsonang-code@users.noreply.github.com"
  git config user.name "wilsonang-code"
  ```
